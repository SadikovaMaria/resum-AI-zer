...
def pdf_to_text(pdf_path):
    # Открываем PDF файл в режиме read-binary
...
def document(message):
    ...
    try:
        ...
        bot.send_message(message.chat.id, "Похоже вы прислали файл не в формате pdf.")
        ...
        try:
            ...
            bot.send_message(message.chat.id, "Не удалось открыть pdf файл, попробуйте еще раз.")
            print(f"Произошла неожиданная ошибка: {e}")
        else:
